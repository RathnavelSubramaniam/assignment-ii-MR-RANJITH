...
# Creating a vector with drawn from a random distribution of 100 observation.
...
#eps is a vector,using rnorm() function with a standard deviation of 0.25
...
#create plot, X and Y there is a positive relationship in linear
...
#The models is statistically significant predictor "chas".
...
#this is multiple regression model to predict the response
